...
[Postprocessors]
  ...
  []
  [peak_elemental_average_outer_fillet]
    type = SideExtremeValue
    boundary = NS.MOUNT_OUTER_FILLETS
    variable = max_principal_stress
  []
  [peak_elemental_average_backplate_interface]
    type = SideExtremeValue
    boundary = NS.MOUNT_BACKPLATE_INTERFACE
    variable = max_principal_stress
  []
  [peak_elemental_average_backplate_fillet]
    type = SideExtremeValue
    boundary = NS.BACKPLATE_STEP_FILLET
    variable = max_principal_stress
  []

  [peak_elemental_average_base_end_fillet]
    type = SideExtremeValue
    boundary = NS.BASE_END_FILLET
    variable = max_principal_stress
  []
  
  [elemental_average_inner_fillet]
    type = SideAverageValue
    boundary = NS.MOUNT_INNER_FILLETS
    variable = max_principal_stress
  []
  [elemental_average_outer_fillet]
    type = SideAverageValue
    boundary = NS.MOUNT_OUTER_FILLETS
    variable = max_principal_stress
  []
  [elemental_average_backplate_interface]
    type = SideAverageValue
    boundary = NS.MOUNT_BACKPLATE_INTERFACE
    variable = max_principal_stress
  []
  [elemental_average_backplate_fillet]
    type = SideAverageValue
    boundary = NS.BACKPLATE_STEP_FILLET
    variable = max_principal_stress
  []

  [elemental_average_base_end_fillet]
    type = SideAverageValue
    boundary = NS.BASE_END_FILLET
    variable = max_principal_stress
  []
