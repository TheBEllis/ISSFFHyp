...
[Mesh]
  [meshy]
    ...
    file = '../../mesh/custom/custom_hyp.cpa.gz'
...
[BCs]
  ...
  [disp_x]
    type = ADDirichletBC
    variable = disp_x
    boundary = 'SS.PIN_HOLE_CONTACT SS.PIN_SLOT_CONTACT'
    value = 0
  [../]
  ...
  [Pressure]
    [bc]
      boundary = 'SS.BASE_WETTED SS.BACKPLATE_WETTED SS.PIPES_WETTED'
